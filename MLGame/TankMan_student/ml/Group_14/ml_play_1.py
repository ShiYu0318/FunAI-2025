...
class MLPlay:
    ...
    def update(self, scene_info: dict, keyboard=[], *args, **kwargs):
        ...
        if self.target_x is None or self.target_y is None:
            ...
            return "RESET"
        x1a=scene_info['competitor_info'][0]['x']
        y1a=scene_info['competitor_info'][0]['y']
        x1b=scene_info['competitor_info'][1]['x']
        y1b=scene_info['competitor_info'][1]['y']
        x1c=scene_info['competitor_info'][2]['x']
        y1c=scene_info['competitor_info'][2]['y']
        x2=scene_info['x']
        y2=scene_info['y']
        # Randomly switch between model_aim and model_chase
        if (self.distance(x1a,y1a,x2,y2)<250 or self.distance(x1b,y1b,x2,y2)<250 or self.distance(x1c,y1c,x2,y2)<250) and (scene_info['competitor_info'][0]['x']-15<=scene_info['x']<=scene_info['competitor_info'][0]['x']+15 or scene_info['competitor_info'][1]['x']-15<=scene_info['x']<=scene_info['competitor_info'][1]['x']+15 or scene_info['competitor_info'][2]['x']-15<=scene_info['x']<=scene_info['competitor_info'][2]['x']+15 or scene_info['competitor_info'][0]['y']-15<=scene_info['y']<=scene_info['competitor_info'][0]['y']+15 or scene_info['competitor_info'][1]['y']-15<=scene_info['y']<=scene_info['competitor_info'][1]['y']+15 or scene_info['competitor_info'][2]['y']-15<=scene_info['y']<=scene_info['competitor_info'][2]['y']+15) or (scene_info['x']==700 and (scene_info['y']==100 or scene_info['y']==200) or scene_info['x']==750 and scene_info['y']==350):#(700,100) (700,200)(750,350)

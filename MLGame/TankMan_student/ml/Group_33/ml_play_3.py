...
# tmp = "train_resupply_Feb06_2025_18-20-02" # 會射擊但不瞄準
# ########################################################################################
# tmp = "train_resupply_Feb06_2025_19-38-57"
# # tmp = "train_resupply_Feb06_2025_20-05-40"
# tmp = "train_resupply_Feb06_2025_18-20-02" # 會射擊但不瞄準
# MODEL_AIM_PATH = os.path.join(MODEL_DIR, rf".\Group_33\model_3a.zip") # aim
# tmp = "train_resupply_Feb06_2025_10-16-40"
# MODEL_CHASE_PATH = os.path.join(MODEL_DIR, rf".\Group_33\model_3b.zip") # chase
...
class MLPlay:
    ...
    def update(self, scene_info: dict, keyboard=[], *args, **kwargs):
        ...
        # 條件改一下 # flag
        if self.dis(scene_info['x'], scene_info['y'], self.target_x, self.target_y) < 200:
            obs = self._get_obs_aim() # SHOOT
            action, _ = self.model_aim.predict(obs, deterministic=True)
            command = COMMAND_AIM[action]
            print('Now is ' + '\033[34m' + 'aim and ' + str(obs) + '\033[0m')
        else:
